            ...
            child: Column(
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                  Text(
                    StringRes.estates,
                    style: lato25500.copyWith(color: ColorRes.appColor,fontSize: 18),
                  ),
                  Container(height: 40,width: 93,
                    decoration: BoxDecoration( color: ColorRes.colorF6F6F6,borderRadius: BorderRadius.circular(10)),
                  child: Row(children: [
                    InkWell(onTap: () {
                      ...
                      child: Container(height: 40,width: 46.5,decoration: BoxDecoration(
                          color: controller.isVertical? ColorRes.appColor: Colors.transparent,borderRadius: BorderRadius.circular(10),
                          image: DecorationImage(image: AssetImage( controller.isVertical!=true? AssetRes.verticalInactive:AssetRes.verticalUnInactive),scale: 4)),),
                    ),
                    InkWell(onTap: () {
                      ...
                      child: Container(height: 40,width: 46.5,decoration: BoxDecoration(
                          color:     controller.isHorizontal?ColorRes.appColor: Colors.transparent,borderRadius: BorderRadius.circular(10),
                          image: DecorationImage(image: AssetImage(   controller.isHorizontal?AssetRes.horizontalActive:AssetRes.horizontalUnActive),scale: 4)),),
                    ),
                  ]),
                  )
                ],),
                SizedBox(height: Get.height * 0.05,),
                controller.isHorizontal!=true? Expanded(
