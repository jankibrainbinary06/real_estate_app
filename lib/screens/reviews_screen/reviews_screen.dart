              ...
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                        ...
                        style: lato20700.copyWith(color: ColorRes.appColor,fontWeight: FontWeight.w600,fontSize: 16),
                      ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(height: 40,width: 115,decoration:
                    BoxDecoration(color: ColorRes.appColor,borderRadius: BorderRadius.circular(5)),child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                      Image.asset(
                        AssetRes.EditSquare,
                        height: 18,
                        width: 18,
                      ...
                      Text(
                        " ${StringRes.addReview}",
                        style: Mulish13700.copyWith(color: ColorRes.white),
                      ),
                    ]),),
                  )
                ],),
              SizedBox(height: 15,),
              Expanded(child: ListView.separated(itemCount: 4,itemBuilder: (context, index) {
                return Container(
                  decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(10),border: Border.all(color: ColorRes.colorBDBFCE)
                  ,  boxShadow: [
                        BoxShadow(
                ...
                child: Padding(
                  ...
                  child: Row(
                      ...
                      children: [
                    CircleAvatar(backgroundImage: AssetImage(AssetRes.User),),
                    Padding(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        Row(
                          children: [
                            Text(
                              "Jin Martin",
                              style: lato20700.copyWith(color: ColorRes.appColor,fontSize: 16),
                            ),
                            SizedBox(width: Get.width * 0.21,),
                            RatingBar.builder(maxRating: 5,minRating: 5,
